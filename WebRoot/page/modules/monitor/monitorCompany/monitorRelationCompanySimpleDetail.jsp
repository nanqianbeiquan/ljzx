...
<html>
  <head>
    ...
    <script type="text/javascript" src="${ctx }/js/modules/monitor/monitorRelationCompanySimpleDetail.js?${appVersion }"></script>
  </head>
            ...
            <div class="body_block_2 block_shadow">
                ...
                <div class="history_content">
                    <div class="company_title">
                        ...
                        <span class="used_name hidden" style="top:-4px;left:3px;">（曾用名：安徽厦门松霖科技有限公司）</span>
                    </div>
                    ...
                    <div class="modules_block_list">
                    	<div class="modules_block current_modules">
                    	    <jsp:include page="/page/modules/company/detail/biz/brefBizDetail.jsp"></jsp:include>
                    	</div>
