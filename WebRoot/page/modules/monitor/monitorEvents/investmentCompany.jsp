...
<input type="hidden" value="${vestpage.recordSum}" id="totalNumInvestmentCompany">
<input type="hidden" value="${companyName}" id="hcompanyName">

 <div class="company_mode mode_block">
                 <div>
			                   		<div class="company_list">
									<c:if test="${empty vestpage  or empty vestpage.results}">无记录！</c:if>
									<c:if test="${not empty vestpage and not empty vestpage.results}">
			                   		<c:forEach items="${vestpage.results}" var="record" varStatus="i">
			                        <div class="company">
			                            <div class="inline_div blank">
			                            </div><div class="inline_div company_info">
			                                <div class="company_name">${record.companyNameInProperties}
