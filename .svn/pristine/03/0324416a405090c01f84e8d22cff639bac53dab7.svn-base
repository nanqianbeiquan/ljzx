...
<div class="table4">
	...
	<c:if test="${not empty page and not empty page.results}">
        <div class="search_result" style="margin-left:30px;margin-bottom:15px;margin-top:10px;">找到&nbsp;${total }&nbsp;条相关结果,为您展示匹配度高的&nbsp;${page.recordSum}&nbsp;条</div>
		<c:forEach items="${page.results}" var="searchResult" varStatus="status">
		  ...
		  <div class="company" style="">
                            ...
                            <c:if test="${searchResult.existFlag==true }">
                            ...
                            <c:if test="${searchResult.existFlag==false }">
