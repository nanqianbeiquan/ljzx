/**   
* @Title: MonitorCompanyRiskAnalysis.java 
* @Package com.srd.ljzd.entity.monitor 
* @Description: TODO(用一句话描述该文件做什么) 
* @author shiyong
* @date 2017年5月12日 上午10:33:19 
* @version V1.0   
*/
package com.srd.ljzd.entity.monitor;
...
/** 
 * @ClassName: MonitorCompanyRiskAnalysis
 * @Description: 动态监控企业风险分析
 * @author shiyong
 * @date 2017年5月12日 上午10:33:19
 *  
 */
@Entity
@Table(name = "monitorcompanyriskanalysis")
public class MonitorCompanyRiskAnalysis {
